...
class Ticket(models.Model):
    ...
    completed_by = models.ForeignKey(User, related_name='completed_by',on_delete=models.CASCADE, null=True)
    LEVEL_CHOICES = (
        ('FIRST', 'New'),
        ('SECOND', 'In Progress'),
        ('THIRD', 'Done'),
    ...
    status = models.CharField(max_length=40, choices=LEVEL_CHOICES, default='FIRST')
